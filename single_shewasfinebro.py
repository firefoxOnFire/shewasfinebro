...
admin = 43444447 # put your id
chat_id = -1001444444450 # put your group id

thread = { # group topics id
...
async def tasker():
    ...
    putter_task = loop.create_task(read_from_queue(bot))


def runner():
    application = Application.builder().post_init(tasker).token(token).build()
